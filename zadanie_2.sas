proc sql;
	ALTER TABLE B_SZKODY DROP FOREIGN KEY  fk_B_SZKODY;
	DROP TABLE B_SZKODY;
	DROP TABLE B_POLISY;
;quit;
proc sql;
	...
	CREATE TABLE B_POLISY (
		...
		CONSTRAINT pk_B_POLISY PRIMARY KEY (ID)
)
;quit;
proc sql;
	...
	CREATE TABLE B_SZKODY (
		...
		CONSTRAINT pk_B_SZKODY PRIMARY KEY (ID)
)
;quit;
proc sql;
	ALTER TABLE B_SZKODY
	ADD CONSTRAINT fk_B_SZKODY
	FOREIGN KEY (ID_POLISY) REFERENCES B_POLISY(ID);
quit;
